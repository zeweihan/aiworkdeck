...
- Exploring MCP-style agent orchestration, document parsing, an embedded LibreOffice editor, AI slides, TTS, OCR, and evidence-chain workflows in one codebase
...
| **Document editing** | Embedded LibreOffice (WASM) editor, real document loading and save-back, AI-driven edits with tracked changes, document links, diff viewing |
...
| `docs/` | Engineering notes, storage and workflow docs |
