...
class AuthControllerHardeningTest {
    ...
    void closedRegistrationShortCircuits() {
        ...
        AuthController controller = new AuthController(
                userService, null, null, null, serverGuard("closed"), null, null, null, sessions());
    ...
    void openRegistrationStillWorks() {
        ...
        AuthController controller = new AuthController(
                userService, null, null, null, serverGuard("open"), null, null, null, sessions());
    ...
    void localModeUnaffectedByClosedGate() {
        ...
        AuthController controller = new AuthController(
                userService, null, null, null, localGuard, null, null, null, sessions());
    ...
    void awdkLoginSuccessEnvelope() {
        ...
        AuthController controller = new AuthController(
                null, null, null, null, serverGuard("open"), awdkLoginService, null, null, sessions());
