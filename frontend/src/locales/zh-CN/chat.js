...
export default {
  activityStatusQueued: '等待应用',
  activityTaskSnapshot: '此处为最后记录的任务进度，未完成项不表示仍在运行。',
  activityTurnSummary: '第 {current}/{total} 轮 · {label}',
  activityPanelTitle: '对话进度',
  activityTasks: '任务 {done}/{total}',
  activityThoughts: '思考 {count}',
  activityProcesses: '执行 {count}',
  activityLocate: '定位',
  activityPreviousTurn: '上一轮',
  activityNextTurn: '下一轮',
  activityEmpty: '暂无记录',
  activityTurnCounter: '第 {current} / {total} 轮',
  activityClose: '关闭进度面板',
  activityProcessNumber: '执行记录 {n}',
  activityJumpToAnswer: '查看回复',
  activityJumpToAttention: '待你处理',
  activityStatusRunning: '进行中',
  activityStatusFinished: '本轮结束',
  activityStatusAwaitingInput: '待回答',
  activityStatusAwaitingApproval: '待确认',
  activityStatusError: '执行出错',
  activityStatusCancelled: '已停止',
  activityStatusPaused: '已暂停',
  activityStatusInterrupted: '已中断',
  activityStatusIdle: '历史记录',
  activityOpenDetails: '查看思考与执行过程',
  activityReply: '回复',
  activityUpdate: '进展说明',
