...
export default {
  ...
  // 即时审校（dev-board#723/#724）：清单在审阅面板的「审校」页，正文里只剩一颗浮球。
  inlineReview: {
    local: '即时规则检查',
    checking: '正在检查',
    stale: '正文已变化，等待重新检查',
    error: '检查暂不可用',
    offTitle: '即时审校已关闭',
    offHint: '开启后会在你停笔时跑一遍结构、编号、交叉引用、算式与证件号码的规则检查。不调用 AI，也不查外部库。',
    empty: '此分类暂无问题',
    staleItem: '等待重新检查',
    locate: '定位原文',
    apply: '采用建议',
    ...
    err: {
      ...
      REVIEW_DEEP_INCOMPLETE: '深入审校未完整完成，以下仅为已完成的检查，可重试。',
    },
    deepReason: {
