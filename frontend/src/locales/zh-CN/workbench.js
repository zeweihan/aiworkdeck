...
export default {
  ...
  // 历史下拉的过滤与行内管理（dev-board#796）
  historyFilterPlaceholder: '按标题或内容筛选…',
  historyFilterEmpty: '没有匹配的对话',
  conversationRename: '重命名',
  conversationPin: '置顶',
  conversationUnpin: '取消置顶',
  conversationPinnedMark: '置顶',
  conversationDelete: '删除',
  conversationDeleteTitle: '删除对话',
  conversationDeleteConfirm: '删除「{name}」的全部对话记录。这条对话里生成的文件和文档检查点都会留在项目里，不受影响。删除后无法恢复。',
  conversationRenameFailed: '重命名失败',
