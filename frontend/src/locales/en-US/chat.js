...
export default {
  activityStatusQueued: 'Waiting to apply',
  activityTaskSnapshot: 'This is the last recorded task progress. Unfinished items may no longer be running.',
  activityTurnSummary: 'Turn {current}/{total} · {label}',
  activityPanelTitle: 'Conversation progress',
  activityTasks: 'Tasks {done}/{total}',
  activityThoughts: 'Thinking {count}',
  activityProcesses: 'Actions {count}',
  activityLocate: 'Navigate',
  activityPreviousTurn: 'Previous turn',
  activityNextTurn: 'Next turn',
  activityEmpty: 'No activity yet',
  activityTurnCounter: 'Turn {current} of {total}',
  activityClose: 'Close activity panel',
  activityProcessNumber: 'Action {n}',
  activityJumpToAnswer: 'View reply',
  activityJumpToAttention: 'Needs your input',
  activityStatusRunning: 'Working',
  activityStatusFinished: 'Turn finished',
  activityStatusAwaitingInput: 'Awaiting answer',
  activityStatusAwaitingApproval: 'Awaiting approval',
  activityStatusError: 'Error',
  activityStatusCancelled: 'Stopped',
  activityStatusPaused: 'Paused',
  activityStatusInterrupted: 'Interrupted',
  activityStatusIdle: 'Recorded',
  activityOpenDetails: 'View thinking and actions',
  activityReply: 'Reply',
  activityUpdate: 'Progress update',
