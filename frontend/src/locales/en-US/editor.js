...
export default {
  ...
  inlineReview: {
    ...
    offTitle: 'Inline review is off',
    offHint: 'When on, it runs structure, numbering, cross-reference, arithmetic and ID checks after you pause typing. It never calls a model or an external database.',
    ...
    refresh: 'Check again',
    deep: 'Deep review (AI)',
    deepBusy: 'Deep review running…',
    deepRetried: 'It was already retried once automatically.',
    enable: 'Enable live checks',
    disable: 'Disable live checks',
    ...
    err: {
      ...
      REVIEW_DEEP_INCOMPLETE: 'Deep review did not finish completely. Only completed checks are shown below; you can retry.',
    },
    deepReason: {
