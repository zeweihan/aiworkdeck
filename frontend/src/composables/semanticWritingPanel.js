...
export function attachSemanticWritingPanel({ canvas, input, transport, focus }) {
  ...
  const style = doc.createElement('style'); style.textContent = `
    .awd-semantic{font:13px/1.55 -apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;color:#20342e;position:fixed;right:16px;top:14px;z-index:2147482600}
    .awd-semantic *{box-sizing:border-box}.awd-semantic button,.awd-semantic input,.awd-semantic textarea,.awd-semantic select{font:inherit}.awd-semantic :focus-visible{outline:3px solid #3a9070;outline-offset:3px}
    .awd-semantic button{border:1px solid #d3ded8;background:#fff;color:#244c3b;border-radius:7px;padding:6px 10px;cursor:pointer}.awd-semantic button:hover{background:#eff5f1}.awd-semantic button:disabled{opacity:.45;cursor:default}
    .awd-semantic-launch{box-shadow:0 2px 8px #133d2514}.awd-semantic-sheet{position:absolute;right:0;top:40px;width:min(420px,calc(100vw - 32px));max-height:calc(100vh - 76px);overflow:auto;background:#fff;border:1px solid #d9e2dc;border-radius:12px;box-shadow:0 16px 48px #143a2529}
    .awd-semantic-head{display:flex;align-items:center;justify-content:space-between;padding:15px 18px;border-bottom:1px solid #e2e8e3}.awd-semantic-head strong{font-size:16px}.awd-semantic-section{padding:14px 18px;border-bottom:1px solid #e2e8e3}.awd-semantic-label{display:block;font-size:12px;font-weight:600;color:#58695f;margin:0 0 5px}.awd-semantic select,.awd-semantic textarea,.awd-semantic input[type=date]{display:block;width:100%;border:1px solid #d5ded8;border-radius:6px;padding:7px;background:white;color:#25382e;margin-bottom:10px}.awd-semantic textarea{resize:vertical;min-height:56px}
    .awd-semantic-files{max-height:126px;overflow:auto;margin:8px 0}.awd-semantic-file{display:flex;gap:8px;align-items:flex-start;padding:5px 0;overflow-wrap:anywhere}.awd-semantic-file input{margin-top:4px}.awd-semantic-actions{display:grid;grid-template-columns:1fr 1fr;gap:8px}.awd-semantic .awd-semantic-primary{background:#20573f;color:#fff;border-color:#20573f}.awd-semantic .awd-semantic-primary:hover{background:#174631}.awd-semantic-hint{font-size:12px;color:#69776f;margin:6px 0;white-space:pre-wrap}.awd-semantic-status{padding:12px 18px;background:#f3f7f4;white-space:pre-wrap;color:#41644f}.awd-semantic-card{padding:15px 18px;border-top:1px solid #e2e8e3}.awd-semantic-preview{font-size:14px;line-height:1.85;white-space:pre-wrap;overflow-wrap:anywhere;margin:8px 0 12px}.awd-semantic details{border-left:2px solid #c7dacc;padding-left:10px;margin:10px 0;color:#51695b}.awd-semantic summary{cursor:pointer;font-size:12px}.awd-semantic blockquote{margin:8px 0;font-size:12px;white-space:pre-wrap;overflow-wrap:anywhere}.awd-semantic [hidden]{display:none!important}
    .theme-dark .awd-semantic{color:#e2ece6}.theme-dark .awd-semantic-sheet{background:#1e2923;border-color:#516258}.theme-dark .awd-semantic button,.theme-dark .awd-semantic select,.theme-dark .awd-semantic textarea,.theme-dark .awd-semantic input[type=date]{background:#28362e;color:#e2ece6;border-color:#667b6d}.theme-dark .awd-semantic button:hover{background:#354a3d}.theme-dark .awd-semantic-section,.theme-dark .awd-semantic-head,.theme-dark .awd-semantic-card{border-color:#48584d}.theme-dark .awd-semantic-label,.theme-dark .awd-semantic-hint,.theme-dark .awd-semantic details{color:#b8cdbf}.theme-dark .awd-semantic-status{background:#2c4034;color:#d0e8d8}.theme-dark .awd-semantic .awd-semantic-primary{background:#97d7b4;border-color:#97d7b4;color:#153a25}.theme-dark .awd-semantic .awd-semantic-primary:hover{background:#b0e6c8}.theme-dark .awd-semantic :focus-visible{outline-color:#a7e7bf}
  `
