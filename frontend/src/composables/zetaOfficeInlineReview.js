...
export function attachInlineReview({ canvas, input, execute, transport, language = 'zh-CN' }) {
  ...
  style.textContent = `.awd-inline-review{position:fixed;inset:0;z-index:9998;pointer-events:none;font:13px/1.5 system-ui,sans-serif;color:var(--awd-text)}.awd-inline-review button{font:inherit;color:inherit;border:1px solid var(--awd-border);border-radius:6px;background:var(--awd-surface);padding:5px 9px;cursor:pointer}.awd-inline-review button:focus-visible{outline:2px solid var(--awd-accent-text);outline-offset:2px}.awd-inline-review button:disabled{opacity:.55;cursor:default}.awd-ir-status{pointer-events:auto;position:absolute;left:18px;bottom:64px;max-width:calc(100vw - 72px);display:flex;align-items:center;gap:8px;padding:7px 8px 7px 11px;background:var(--awd-surface);border:1px solid var(--awd-border);border-radius:9px;box-shadow:var(--awd-shadow-md);cursor:move;user-select:none}.awd-ir-status-label{white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.awd-ir-chip{pointer-events:auto;position:absolute;box-shadow:var(--awd-shadow-md);white-space:nowrap}.awd-ir-panel{pointer-events:auto;position:absolute;width:380px;max-width:calc(100vw - 24px);max-height:70vh;display:flex;flex-direction:column;padding:0;background:var(--awd-surface);border:1px solid var(--awd-border);border-radius:9px;box-shadow:var(--awd-shadow-lg)}.awd-ir-head,.awd-ir-actions{display:flex;align-items:center;gap:7px;flex-wrap:wrap}.awd-ir-head{justify-content:space-between;padding:10px 12px;cursor:move;user-select:none;border-bottom:1px solid var(--awd-border-subtle)}.awd-ir-head-actions{display:flex;gap:6px}.awd-ir-body{overflow:auto;padding:0 12px 12px;overscroll-behavior:contain}.awd-ir-tabs{position:sticky;top:0;z-index:1;display:flex;flex-wrap:wrap;gap:5px;padding:9px 0 6px;background:var(--awd-surface);border-bottom:1px solid var(--awd-border-subtle)}.awd-ir-tabs button{white-space:nowrap}.awd-ir-tabs button[aria-selected=true]{background:var(--awd-accent-soft);border-color:var(--awd-bamboo)}.awd-ir-item{border-top:1px solid var(--awd-border-subtle);margin-top:10px;padding-top:9px}.awd-ir-copy{white-space:pre-wrap;word-break:break-word;margin:6px 0}.awd-ir-note{font-size:11px;color:var(--awd-text-2);margin:7px 0}.awd-inline-review [hidden]{display:none!important}`
