...
## 状态表（2026-09-23 11:10：K1–K42 全部合入 master 并随 v0.46.3 发版；K43 #948 等 CI；全部进入维护者复测阶段）
...
| K40 发版门断流查因 + 异常断流重连死代码 | #821 | 3 | useAgentStream/run.mjs | 已合并 | #946 |
| K41 只读 AI 轮不开工作段 | #822 | 3 | WorkSessionService | 已合并 | #945 |
| K42 J12/J6.5 判据改「轮次落定 + 历史落库」 | #823 | 3 | run.mjs | 已合并（关卡） | #944 |
| K43 离开页面前先等本轮流式结束 | #826 | 3 | run.mjs/eng-infra.md | 已开 PR（auto-merge） | #948 |
